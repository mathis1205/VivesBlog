...
public class VivesBlogDbContext(DbContextOptions<VivesBlogDbContext> options) : DbContext(options)
{
    ...
    public void Seed()
    {
        ...
        [
            new Article
            {
                Title = "Understanding C# Records", Author = "Jane Doe", PublishedDate = new DateTime(2023, 10, 5),
                Description =
            ...
            new Article
            {
                Title = "Getting Started with ASP.NET Core", Author = "John Smith",
            ...
            new Article
            {
                Title = "C# 10 Features You Need to Know", Author = "Alex Johnson",
